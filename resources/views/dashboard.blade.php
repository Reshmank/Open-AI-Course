...
@section('content')
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="course_title" aria-describedby="emailHelp" placeholder="Enter Course Title">
   
  </div><a href="#" class="btn btn-success" id="generateAi">generate content</a>
  <div class="form-group">
